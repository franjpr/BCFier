...
[Files]
;STANDALONE
Source: "{#Repository}\{#WinAppName}\bin\Debug\{#WinAppName}.exe"; DestDir: "{app}"; Flags: ignoreversion; Permissions: everyone-full; Components: standalone
Source: "{#Repository}\{#WinAppName}\bin\Debug\Bcfier.dll"; DestDir: "{app}"; Flags: ignoreversion; Components: standalone
